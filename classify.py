...
class configs():
  ...
  """
  outputDirectory = '/content/drive/MyDrive/cs9875/CourseProject/outputs'
...
class classification():
  ...
  def __init__(self, X:np.ndarray, y:np.ndarray) -> None:
    ...
    self.outputDirectory = self.configs.outputDirectory
  ...
  def output(self):
    print('\nTraining...\n')
    models = ['SVC', 'LG', 'XGBoost', 'Lasso', 'NaiveBayes', 'KNN', 'CNN']
...
if __name__ == '__main__':
  ...
  y : 1D nparray --> labels
  """
  X = np.array() # modify here
  y = np.array() # modify here
